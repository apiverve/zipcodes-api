...
const (
	baseURL        = "https://api.apiverve.com/v1/zipcodes"
	defaultTimeout = 30 * time.Second
)

// Client is the Zip Codes Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Zip Codes Lookup API client.
...
// Execute makes a request to the Zip Codes Lookup API with typed parameters.
//
