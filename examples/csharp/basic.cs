...
namespace APIVerve.Examples
{
    class ZipCodesLookupExample
    {
        ...
        {
            Console.WriteLine("📤 Calling Zip Codes Lookup API...\n");

            var result = await CallZipCodesLookupAPI();
