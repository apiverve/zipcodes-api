# Zip Codes Lookup API - Examples

This folder contains example code for using the Zip Codes Lookup API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/zipcodes',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/zipcodes");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/zipcodes](https://docs.apiverve.com/ref/zipcodes)
