...
```gradle
dependencies {
    implementation 'com.github.apiverve:zipcodes-api:1.1.14'
}
```
...
```java
import com.apiverve.zipcodes.ZipCodesLookupAPIClient;
import com.apiverve.zipcodes.APIResponse;
import com.apiverve.zipcodes.APIException;

// Initialize the client
ZipCodesLookupAPIClient client = new ZipCodesLookupAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/zipcodes](https://docs.apiverve.com/ref/zipcodes)
...
- **Documentation:** [https://docs.apiverve.com/ref/zipcodes](https://docs.apiverve.com/ref/zipcodes)
- **Issues:** [GitHub Issues](https://github.com/apiverve/zipcodes-api/issues)
